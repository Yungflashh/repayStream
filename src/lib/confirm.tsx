        ...
        <AnimatePresence>
          {pending && (
            <>
              ...
              {/* Centering shell — plain div so no transform conflict with Framer Motion */}
              <div
                key="shell"
              ...
              >
                ...
                >
                  <div className="rounded-2xl border border-border/40 bg-card p-6 shadow-2xl shadow-black/30">
                    {/* Icon + title */}
