...
const brandPoints = [
  { icon: Zap,          label: "Go live in under 10 minutes" },
  { icon: Users,        label: "Customer portal included free" },
  { icon: TrendingUp,   label: "Repayment analytics dashboard" },
    ...
    <div className="flex min-h-dvh">
        ...
        <div className="relative z-10 space-y-10">
          <div className="space-y-5">
            <div className="inline-flex items-center gap-2 rounded-full border border-[rgba(0,180,70,0.3)] bg-[rgba(0,180,70,0.1)] px-3 py-1">
              ...
              <span className="text-xs font-semibold tracking-wide text-primary">Free to get started</span>
            </div>
            ...
            <p className="max-w-sm text-sm leading-relaxed text-white/55">
              Join lenders across Nigeria using RepayStream to recover loans faster with automated, CBN-compliant direct debit mandates.
            </p>
          </div>
      ...
      <div className="flex flex-1 flex-col bg-background">
        ...
        <div className="flex flex-1 items-center justify-center px-6 py-8 sm:px-12">
          ...
          >
            <div className="mb-8">
              <h1 className="rs-serif text-3xl sm:text-4xl text-foreground">Create account</h1>
